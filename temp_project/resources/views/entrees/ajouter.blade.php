...
<div class="page-header">
    <div>
        <h1> Nouvelle entrée stock</h1>
        <p style="color:#888; font-size:14px; margin-top:4px;">Enregistrer une réception de stupéfiants</p>
    </div>
    <a href="/entrees" class="btn-back">← Retour</a>
</div>

<div class="form-card">
    <form action="/entrees/ajouter" method="POST">
        @csrf
        <div class="grid-2">
            <div class="form-group">
                <label> Numéro de bon</label>
                <input type="text" name="numero_bon" placeholder="Ex: ENT-001" required>
            </div>
            <div class="form-group">
                <label> Produit</label>
        ...
        <div class="grid-2">
            <div class="form-group">
                ...
                <input type="number" name="quantite" placeholder="Ex: 100" min="1" required>
            </div>
            <div class="form-group">
                <label> Fournisseur</label>
                <input type="text" name="fournisseur" placeholder="Ex: Pharma Maroc" required>
            </div>
        </div>
        <div class="form-group">
        ...
        <button type="submit" class="btn-submit"> Enregistrer l'entrée</button>
    </form>
</div>
